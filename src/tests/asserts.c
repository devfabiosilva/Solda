...
typedef struct c_test_header {
  ...
  size_t tests, next, ignored;

  uint64_t initial_timestamp, final_timestamp;

  header_on_cb on_add_test_fn, on_test_fn, on_begin_test_fn, on_end_test_fn,
      on_abort_fn;
...
const uint32_t C_TEST_VARGS_MSG_SIGS[] = {C_TEST_VARGS_TITLE,
                                          C_TEST_VARGS_INFO,
                                          C_TEST_VARGS_WARNING,
                                          C_TEST_VARGS_ERROR,
                                          C_TEST_VARGS_SUCCESS,
                                          C_TEST_VARGS_ON_SUCCESS_CALLBACK,
                                          C_TEST_VARGS_ON_ERROR_CALLBACK};

#define C_TEST_VARGS_MSG_SIGS_SIZE \
  (sizeof(C_TEST_VARGS_MSG_SIGS) / sizeof(C_TEST_VARGS_MSG_SIGS[0]))
...
typedef struct c_test_vargs_msg_t {
  ...
  cb_fn on_success_cb, on_error_cb;
} C_TEST_VARGS_MSG;
...
static C_TEST_VARGS_MSG *check_vargs_sigmsg_exists(C_TEST_VARGS_MSG **,
                                                   uint32_t);
...
#define ASSERT_NOT_EQUAL_STRING_IGNORE_CASE \
  "assert_not_equal_string_ignore_case"
...
static C_TEST_FN_DESCRIPTION _tst_fn_desc[] = {
    {TYPE_ASSERT_EQUAL_INT, ASSERT_EQ_INT_FN, sizeof(C_TEST_TYPE_INT),
     print_assert_int},
    {TYPE_ASSERT_TRUE, ASSERT_TRUE_FN, sizeof(C_TEST_TYPE_BOOL),
     print_assert_int},
    {TYPE_ASSERT_FALSE, ASSERT_FALSE_FN, sizeof(C_TEST_TYPE_BOOL),
     print_assert_int},
    {TYPE_ASSERT_EQUAL_LONG_INT, ASSERT_EQUAL_LONG_INT,
     sizeof(C_TEST_TYPE_LONG_INT), print_assert_longint},
    {TYPE_ASSERT_EQUAL_DOUBLE, ASSERT_EQUAL_DOUBLE, sizeof(C_TEST_TYPE_DOUBLE),
     print_assert_double},
    {TYPE_ASSERT_EQUAL_BYTE, ASSERT_EQUAL_BYTE, sizeof(C_TEST_TYPE_BYTE),
     print_assert_byte},
    {TYPE_ASSERT_NOT_EQUAL_INT, ASSERT_NOT_EQUAL_INT_FN,
     sizeof(C_TEST_TYPE_INT), print_assert_int},
    {TYPE_ASSERT_NOT_EQUAL_LONG_INT, ASSERT_NOT_EQUAL_LONG_INT,
     sizeof(C_TEST_TYPE_LONG_INT), print_assert_longint},
    {TYPE_ASSERT_NOT_EQUAL_DOUBLE, ASSERT_NOT_EQUAL_DOUBLE,
     sizeof(C_TEST_TYPE_DOUBLE), print_assert_double},
    {TYPE_ASSERT_NOT_EQUAL_BYTE, ASSERT_NOT_EQUAL_BYTE,
     sizeof(C_TEST_TYPE_BYTE), print_assert_byte},
    {TYPE_ASSERT_EQUAL_STRING, ASSERT_EQUAL_STRING, sizeof(C_TEST_TYPE_STRING),
     print_assert_string},
    {TYPE_ASSERT_NOT_EQUAL_STRING, ASSERT_NOT_EQUAL_STRING,
     sizeof(C_TEST_TYPE_STRING), print_assert_string},
    {TYPE_ASSERT_EQUAL_STRING_IGNORE_CASE, ASSERT_EQUAL_STRING_IGNORE_CASE,
     sizeof(C_TEST_TYPE_STRING), print_assert_string},
    {TYPE_ASSERT_NOT_EQUAL_STRING_IGNORE_CASE,
     ASSERT_NOT_EQUAL_STRING_IGNORE_CASE, sizeof(C_TEST_TYPE_STRING),
     print_assert_string},
    {TYPE_ASSERT_NULL, ASSERT_NULL, sizeof(C_TEST_TYPE_NULLABLE),
     print_assert_nullable},
    {TYPE_ASSERT_NOT_NULL, ASSERT_NOT_NULL, sizeof(C_TEST_TYPE_NULLABLE),
     print_assert_nullable},
    {TYPE_ASSERT_EQUAL_U8, ASSERT_EQUAL_U8, sizeof(C_TEST_TYPE_U8),
     print_assert_u8},
    {TYPE_ASSERT_NOT_EQUAL_U8, ASSERT_NOT_EQUAL_U8, sizeof(C_TEST_TYPE_U8),
     print_assert_u8},
    {TYPE_ASSERT_EQUAL_S8, ASSERT_EQUAL_S8, sizeof(C_TEST_TYPE_S8),
     print_assert_s8},
    {TYPE_ASSERT_NOT_EQUAL_S8, ASSERT_NOT_EQUAL_S8, sizeof(C_TEST_TYPE_S8),
     print_assert_s8},
    {TYPE_ASSERT_EQUAL_U16, ASSERT_EQUAL_U16, sizeof(C_TEST_TYPE_U16),
     print_assert_u16},
    {TYPE_ASSERT_NOT_EQUAL_U16, ASSERT_NOT_EQUAL_U16, sizeof(C_TEST_TYPE_U16),
     print_assert_u16},
    {TYPE_ASSERT_EQUAL_S16, ASSERT_EQUAL_S16, sizeof(C_TEST_TYPE_S16),
     print_assert_s16},
    {TYPE_ASSERT_NOT_EQUAL_S16, ASSERT_NOT_EQUAL_S16, sizeof(C_TEST_TYPE_S16),
     print_assert_s16},
    {TYPE_ASSERT_EQUAL_U32, ASSERT_EQUAL_U32, sizeof(C_TEST_TYPE_U32),
     print_assert_u32},
    {TYPE_ASSERT_NOT_EQUAL_U32, ASSERT_NOT_EQUAL_U32, sizeof(C_TEST_TYPE_U32),
     print_assert_u32},
    {TYPE_ASSERT_EQUAL_S32, ASSERT_EQUAL_S32, sizeof(C_TEST_TYPE_S32),
     print_assert_s32},
    {TYPE_ASSERT_NOT_EQUAL_S32, ASSERT_NOT_EQUAL_S32, sizeof(C_TEST_TYPE_S32),
     print_assert_s32},
    {TYPE_ASSERT_EQUAL_U64, ASSERT_EQUAL_U64, sizeof(C_TEST_TYPE_U64),
     print_assert_u64},
    {TYPE_ASSERT_NOT_EQUAL_U64, ASSERT_NOT_EQUAL_U64, sizeof(C_TEST_TYPE_U64),
     print_assert_u64},
    {TYPE_ASSERT_EQUAL_S64, ASSERT_EQUAL_S64, sizeof(C_TEST_TYPE_S64),
     print_assert_s64},
    {TYPE_ASSERT_NOT_EQUAL_S64, ASSERT_NOT_EQUAL_S64, sizeof(C_TEST_TYPE_S64),
     print_assert_s64},
    {TYPE_ASSERT_EQUAL_UNSIGNED_LONG_INT, ASSERT_EQUAL_UNSIGNED_LONG_INT,
     sizeof(C_TEST_TYPE_UNSIGNED_LONG_INT), print_assert_unsigned_longint},
    {TYPE_ASSERT_NOT_EQUAL_UNSIGNED_LONG_INT,
     ASSERT_NOT_EQUAL_UNSIGNED_LONG_INT, sizeof(C_TEST_TYPE_UNSIGNED_LONG_INT),
     print_assert_unsigned_longint},
    {TYPE_ASSERT_FAIL, ASSERT_FAIL, sizeof(C_TEST_TYPE_FAIL),
     print_assert_fail}};
...
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_LONG_INT \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_LONG_INT]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_UNSIGNED_LONG_INT \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_UNSIGNED_LONG_INT]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_UNSIGNED_LONG_INT \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_UNSIGNED_LONG_INT]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_DOUBLE \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_DOUBLE]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_BYTE \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_BYTE]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_INT \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_INT]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_LONG_INT \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_LONG_INT]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_DOUBLE \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_DOUBLE]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_BYTE \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_BYTE]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_STRING \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_STRING]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_STRING \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_STRING]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_STRING_IGNORE_CASE \
  _tst_fn_desc[TYPE_ASSERT_EQUAL_STRING_IGNORE_CASE]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_STRING_IGNORE_CASE \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_STRING_IGNORE_CASE]
...
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_U8 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_U8]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_S8 _tst_fn_desc[TYPE_ASSERT_EQUAL_S8]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_S8 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_S8]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_U16 _tst_fn_desc[TYPE_ASSERT_EQUAL_U16]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_U16 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_U16]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_S16 _tst_fn_desc[TYPE_ASSERT_EQUAL_S16]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_S16 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_S16]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_U32 _tst_fn_desc[TYPE_ASSERT_EQUAL_U32]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_U32 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_U32]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_S32 _tst_fn_desc[TYPE_ASSERT_EQUAL_S32]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_S32 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_S32]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_U64 _tst_fn_desc[TYPE_ASSERT_EQUAL_U64]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_U64 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_U64]
#define C_TEST_FN_DESCRIPTION_ASSERT_EQ_S64 _tst_fn_desc[TYPE_ASSERT_EQUAL_S64]
#define C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_S64 \
  _tst_fn_desc[TYPE_ASSERT_NOT_EQUAL_S64]
// TODO
...
inline static void end_test_msg_util(size_t tst) {
  if (tst) WARN_MSG_FMT("WARNING: %d test(s) ignored", tst)
}
  ...
  if (_c_test_ptr) {
    ...
    if (abort) {
      ...
      ERROR_MSG_FMT("Aborting TESTS.\nAt %s\nTotal: %d\nTest(s): %d finished",
                    ctime(&t), ((C_TEST_HEADER *)_c_test_ptr)->next,
                    ((C_TEST_HEADER *)_c_test_ptr)->next -
      ...
      TITLE_MSG_FMT("*** END TESTS ***\nTotal: %d\nTest(s): %d\nAt: %s",
                    ((C_TEST_HEADER *)_c_test_ptr)->tests,
                    ((C_TEST_HEADER *)_c_test_ptr)->next -
                        ((C_TEST_HEADER *)_c_test_ptr)->ignored,
                    ctime(&t))
    ...
    if (((C_TEST_HEADER *)_c_test_ptr)->tests)
      memset(_c_test_ptr + sizeof(C_TEST_HEADER), 0,
             (((C_TEST_HEADER *)_c_test_ptr)->tests) * sizeof(C_TEST_FN));
    ...
    ERROR_MSG(
        "\nERROR: Null pointer. Probably you start ctest with invalid "
        "argument. Aborting C test.\n")
  else
    WARN_MSG(
        "\nWARNING: Null pointer. Probably you start ctest with invalid "
        "argument. Ignoring ...\n")
}
...
void _c_test_ignore() { c_test_not_ignored = C_TEST_FALSE; }

void _c_test_ignore_end() { c_test_not_ignored = C_TEST_TRUE; }
...
static void begin_test(void *vas) {
  ...
  if (c_test_not_ignored) {
    TITLE_MSG_FMT("Testing %d -> \"%s\" (%p)...",
                  ((C_TEST_HEADER *)_c_test_ptr)->next, q->meta.fn_name, q)
    q->meta.cb(q, vas);
    ...
    free_vargs(vas);
    ((C_TEST_HEADER *)_c_test_ptr)->ignored++;
    WARN_MSG_FMT("WARNING: Ignoring %d -> \"%s\" (%p)...",
                 ((C_TEST_HEADER *)_c_test_ptr)->next, q->meta.fn_name, q)
  }
}
...
#define ON_TEST_WARN1                                                        \
  "WARNING: %s callback already exists at pointer (%p). Overwriting with a " \
  "new callback pointer (%p)"
#define ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(fn_name, ptr) \
  if (ptr) WARN_MSG_FMT(ON_TEST_WARN1, fn_name, ptr, fn);
...
#define p _c_test_ptr
  ...
  if (!p) {
    if (!(p = malloc(sizeof(C_TEST_HEADER)))) {
      ERROR_MSG(
          "Fatal: on_add_test missing callback function. Can't alloc memory")
      abort_tests();
    }
  ...
  ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(ON_ADD_TEST_STR,
                                           C_TEST_ON_ADD_FN_POINTER)
...
#define p _c_test_ptr
  ...
  if (!p) {
    if (!(p = malloc(sizeof(C_TEST_HEADER)))) {
      ERROR_MSG(
          "Fatal: on_begin_test missing callback function. Can't alloc memory")
      abort_tests();
    }
  ...
  ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(ON_BEGIN_TEST_STR,
                                           C_TEST_ON_BEGIN_FN_POINTER)
...
#define p _c_test_ptr
  ...
  ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(ON_TEST_STR,
                                           C_TEST_ON_TEST_FN_POINTER)
...
#define p _c_test_ptr
  ...
  if (!p) {
    if (!(p = malloc(sizeof(C_TEST_HEADER)))) {
      ERROR_MSG(
          "Fatal: on_end_test missing callback function. Can't alloc memory")
      abort_tests();
    }
  ...
  ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(ON_END_TEST_STR,
                                           C_TEST_ON_END_FN_POINTER)
...
#define p _c_test_ptr
  ...
  ON_TEST_WARN1_IF_CALLBACK_ALREADY_EXISTS(ON_ABORT_STR,
                                           C_TEST_ON_ABORT_FN_POINTER)
...
_Static_assert(sizeof(int) >= sizeof(uint32_t),
               "Processor architecture should be 32 bit or more");
//
...
static inline int c_test_is_header_invalid(C_TEST_VARGS_MSG_HEADER *header) {
  if (header->sig ^ C_TEST_VARGS_SETTER) return -2;

  if (header->sig_chk ^ C_TEST_VARGS_SETTER_CHK_SUM) return -3;

  return 0;
  //   return
  //   ((header->sig^C_TEST_VARGS_SETTER)|(header->sig_chk^C_TEST_VARGS_SETTER_CHK_SUM));
  //   // Memory sanity check
}
...
static C_TEST_VARGS_MSG_HEADER *c_test_vargs_create() {
  ...
  if (!(c_vargs = malloc(C_VARGS_SZ))) return NULL;
  ...
  memset(((C_TEST_VARGS_MSG_HEADER *)c_vargs)->vargs_msgs, 0,
         sizeof(C_TEST_VARGS_MSG *) * (C_TEST_VARGS_MSG_SIGS_SIZE + 1));
  return (C_TEST_VARGS_MSG_HEADER *)c_vargs;
}

static C_TEST_VARGS_MSG *check_vargs_sigmsg_exists(
    C_TEST_VARGS_MSG **test_vargs_msg, uint32_t sig) {
  C_TEST_VARGS_MSG **p;

  p = test_vargs_msg;

  for (; (*p); p++)
    if ((*p)->sig == sig) return (*p);
...
static uint32_t check_msgsig(C_TEST_VARGS_MSG *va_msg) {
  ...
  for (; i < C_TEST_VARGS_MSG_SIGS_SIZE;)
    if (va_msg->sig == C_TEST_VARGS_MSG_SIGS[i++]) return va_msg->sig;
...
static int free_vargs(void *vargs) {
  ...
  while (*p) {
    if (!check_msgsig(*p)) {
      ...
      err = 7;
      ERROR_MSG(
          "ERROR: check_msgsig(). Missing or invalid message signature. Maybe "
          "wrong parameters. Ignoring free argument")
      continue;
    }
    ...
    if ((*p)->sig & C_TEST_TYPE_VARGS_MSG) {
      if ((*p)->msg_sz >= 0) {
        ...
        ERROR_MSG_FMT(
            "ERROR %d: free_vargs(). Error dealloc message. Signature = %04x "
            "at address = (%p)",
            (err = (*p)->msg_sz), (*p)->sig, (*p))
...
static int close_varg(C_TEST_VARGS_MSG *varg) {
  ...
  if (!check_msgsig(varg)) {
    WARN_MSG_FMT(
        "WARNING: check_msgsig() @ close_varg. Signature not found in address "
        "(%p). Ignoring closing",
        (void *)varg)
  ...
  if (varg->sig & C_TEST_TYPE_VARGS_MSG) {
    if (varg->msg_sz >= 0) {
      if (varg->msg) free(varg->msg);

    } else
      WARN_MSG_FMT(
          "WARNING %d: close_varg(). Message may be a wrong format at address "
          "(%p). Closing vargs...",
          err = varg->msg_sz, (void *)varg)
    ...
    WARN_MSG(
        "WARNING: close_varg(). Unknown argument type. Ignoring and close ...");
...
void *set_varg(uint32_t sig, const char *message, ...) {
  ...
  if ((sig & C_TEST_TYPE_VARGS_MSG) == 0) return NULL;

  if (!(varg_tmp = malloc(sizeof(C_TEST_VARGS_MSG)))) return NULL;
...
#define VARG_ERROR_MSG_NULL_PARM \
  "ERROR: CTEST_SETTER has NULL parameter at argument %d."
#define VARG_ERROR_MSG_MANY_ARGUMENTS \
  "ERROR: CTEST_SETTER has too many arguments"
void *vargs_setter(int initial, ...) {
  ...
  if (initial != -1) {
    ERROR_MSG(
        "ERROR: Initial value is wrong. Please consider use \"CTEST_SETTER\" "
        "instead. Ignoring parameter ...")
    return NULL;
  }
...
#define MAX_ARG_OVF (size_t) C_TEST_VARGS_MSG_SIGS_SIZE + 2
  while ((argc++) < (MAX_ARG_OVF + 1)) {
    ...
    if ((v = (void *)va_arg(args, void *)) == VA_END_SIGNATURE) break;
    ...
    if (!v) {
      ...
      if (v) goto while_vargs_continue;
  ...
  if (argc > 2)
    ...
    if (!err) return (C_TEST_VARGS_MSG_HEADER *)VA_END_SIGNATURE;

    ERROR_MSG_FMT("ERROR %d: Invalid empty args", err);
    return NULL;
  } else {
    ERROR_MSG(
        "ERROR: vargs_setter must be initialized only with CTEST_SETTER "
        "macro.");
    return NULL;
  }
  ...
  vargs_setter_RET:
    ERROR_MSG_FMT(
        "Error(s) occurred with last error %d. Closing arguments before quit "
        "...",
        err);
    ...
    for (initial = 0; initial < argc; initial++) {
      ...
      if ((err = close_varg(
               (C_TEST_VARGS_MSG *)(v = (void *)va_arg(args, void *))))) {
        if (err == CLOSE_VARG_ERR_WRONG_SIG)
          if (!c_test_is_header_invalid((C_TEST_VARGS_MSG_HEADER *)v)) {
            ERROR_MSG(
                "Error: Found forbidden arguments inside argument setter. "
                "Trying to close");

            if ((err = free_vargs((C_TEST_VARGS_MSG_HEADER *)v)))
              ERROR_MSG_FMT("Error %d: Closing failed", err)
            else
              INFO_MSG("Closed success!");
          }
    ...
    if (ret) {
      ...
      free(ret);  // All children was cleared using close_varg. Here we will NOT
                  // use free_vargs() in this case
    }
  ...
  for (initial = 0; initial < argc; initial++) {
    if (check_vargs_sigmsg_exists(
            ret->vargs_msgs,
            ((C_TEST_VARGS_MSG *)(v = (void *)va_arg(args, void *)))->sig)) {
      err = -127;
...
#define MAX_ARG 3 + 1
  *vargs = NULL;
  ...
  for (i = 0; i < MAX_ARG;) {
    ...
    if ((ptr[i++] = (void *)va_arg(ap, void *)) == VAS_END_SIGNATURE) break;
  }
  va_end(ap);
#undef MAX_ARG

  if (i == 1) return LOAD_TEST_VARGS_ERROR_MISSING_ARGUMENTS;

  (i == 2) ? (i = 0) : (i = 1);

  if (ptr[i++]) return LOAD_TEST_VARGS_ERROR_LOAD_WRONG_ARGUMENT_1;

  if (ptr[i] != VAS_END_SIGNATURE)
    return LOAD_TEST_VARGS_ERROR_LOAD_WRONG_ARGUMENT_2;

  if (ptr[1] == VAS_END_SIGNATURE) return LOAD_TEST_VARGS_END_SIGNATURE;

  if (!ptr[0]) return LOAD_TEST_VARGS_ERROR_IS_NULL;
...
static char *parse_vas_msg(int *msg_sz, void *vas, uint32_t sig) {
  ...
  *msg_sz = 0;
  ...
  p = NULL;
  if ((res = check_vargs_sigmsg_exists(
           ((C_TEST_VARGS_MSG_HEADER *)vas)->vargs_msgs, sig)))
    if (res->msg_sz > 0) {
      p = res->msg;
      *msg_sz = res->msg_sz;
    }
...
static void print_assert_int(void *ctx, void *vas) {
  ...
  const char *print_assert_int_msg[][2] = {
      {"\"%s\". FALSE (%d) -> ok",
       "\"%s\". Expected FALSE (%d), but found TRUE (%d) -> fail"},
      {"\"%s\". TRUE (%d) -> ok",
       "\"%s\". Expected TRUE (%d), but found FALSE (%d) -> fail"},
      {"\"%s\". Expected %d (0x%08x) == result %d (0x%08x) -> ok",
       "\"%s\". Expected %d (0x%08x), but found %d (0x%08x) -> fail"},
      {"\"%s\". Unexpected %d (0x%08x) != result %d (0x%08x) -> ok",
       "\"%s\". Unexpected %d (%08x) == result %d (0x%08x) -> fail"}};
  ...
  if (error) {
    ...
    if (idx > 1)
      ERROR_MSG_FMT(print_assert_int_msg[idx][1], type->header.desc.fn_name,
                    type->expected, type->expected, type->result, type->result)
    else
      ERROR_MSG_FMT(print_assert_int_msg[idx][1], type->header.desc.fn_name,
  ...
  if (idx > 1)
    SUCCESS_MSG_FMT(print_assert_int_msg[idx][0], type->header.desc.fn_name,
                    type->expected, type->expected, type->result, type->result)
  else
    SUCCESS_MSG_FMT(print_assert_int_msg[idx][0], type->header.desc.fn_name,
                    type->expected, type->result)
...
static void print_assert_longint(void *ctx, void *vas) {
  ...
  const char *print_assert_long_int_msg[][2] = {
      {"\"%s\". Expected %lld (0x%016llx) == result %lld (0x%016llx) -> ok",
       "\"%s\". Expected %lld (0x%016llx), but found %lld (0x%016llx) -> fail"},
      {"\"%s\". Unexpected %lld (0x%016llx) != result %lld (0x%016llx) -> ok",
       "\"%s\". Unexpected %lld (%016llx) == result %lld (0x%016llx) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_long_int_msg[idx][1], type->header.desc.fn_name,
                  type->expected, type->expected, type->result, type->result)
  ...
  SUCCESS_MSG_FMT(print_assert_long_int_msg[idx][0], type->header.desc.fn_name,
                  type->expected, type->expected, type->result, type->result)
}
...
static void print_assert_unsigned_longint(void *ctx, void *vas) {
  ...
  const char *print_assert_unsigned_long_int_msg[][2] = {
      {"\"%s\". Expected %llu (0x%016llx) == result %llu (0x%016llx) -> ok",
       "\"%s\". Expected %llu (0x%016llx), but found %llu (0x%016llx) -> fail"},
      {"\"%s\". Unexpected %llu (0x%016llx) != result %llu (0x%016llx) -> ok",
       "\"%s\". Unexpected %llu (%016llx) == result %llu (0x%016llx) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_unsigned_long_int_msg[idx][1],
                  type->header.desc.fn_name, type->expected, type->expected,
...
static void print_assert_double(void *ctx, void *vas) {
  ...
  const char *print_assert_long_int_msg[][2] = {
      {"\"%s\". Expected %.17g == result %.17g with delta = %e -> ok",
       "\"%s\". Expected %.17g, but found %.17g with delta = %e -> fail"},
      {"\"%s\". Unexpected %.17g != result %.17g with delta = %e -> ok",
       "\"%s\". Unexpected %.17g == result %.17g with delta = %e -> fail"}};
...
static void print_assert_byte(void *ctx, void *vas) {
  ...
  const char *print_assert_byte_msg[][2] = {
      {"\"%s\". (%llu) bytes at pointer expected (%p) == pointer result (%p) "
       "-> ok",
       "\"%s\". (%llu) bytes at pointer expected (%p) != pointer result (%p) "
       "-> fail"},
      {"\"%s\". (%llu) bytes at pointer unexpected (%p) != pointer result (%p) "
       "-> ok",
       "\"%s\". (%llu) bytes at pointer unexpected (%p) == pointer result (%p) "
       "-> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_byte_msg[idx][1], type->header.desc.fn_name,
                  type->size, type->expected, type->result)
  ...
  SUCCESS_MSG_FMT(print_assert_byte_msg[idx][0], type->header.desc.fn_name,
                  type->size, type->expected, type->result)
}
...
static void print_assert_string(void *ctx, void *vas) {
  ...
  const char *print_assert_string_msg[][2] = {
      {"\"%s\". Expected \"%s\" at pointer (%p) == result \"%s\" at pointer "
       "(%p) -> ok",
       "\"%s\". Expected \"%s\" at pointer (%p) != result \"%s\" at pointer "
       "(%p) -> fail"},
      {"\"%s\". Unexpected \"%s\" at pointer (%p) != result \"%s\" at pointer "
       "(%p) -> ok",
       "\"%s\". Unexpected \"%s\" at pointer (%p) == result \"%s\" at pointer "
       "(%p) -> fail"}};
  ...
  error = ((type->header.desc.type == TYPE_ASSERT_EQUAL_STRING_IGNORE_CASE) ||
           (type->header.desc.type == TYPE_ASSERT_NOT_EQUAL_STRING_IGNORE_CASE))
              ? (strcasecmp(type->expected, type->result))
              : (strcmp(type->expected, type->result));

  idx = 0;
  if ((type->header.desc.type == TYPE_ASSERT_NOT_EQUAL_STRING) ||
      (type->header.desc.type == TYPE_ASSERT_NOT_EQUAL_STRING_IGNORE_CASE)) {
    idx = 1;
    error = !error;
  }
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_string_msg[idx][1], type->header.desc.fn_name,
                  type->expected, type->expected, type->result, type->result)
  ...
  SUCCESS_MSG_FMT(print_assert_string_msg[idx][0], type->header.desc.fn_name,
                  type->expected, type->expected, type->result, type->result)
}
...
static void print_assert_nullable(void *ctx, void *vas) {
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_nullable_msg[idx][1], type->header.desc.fn_name,
                  (type->pointer) ? (type->pointer) : "NULL")
  ...
  SUCCESS_MSG_FMT(print_assert_nullable_msg[idx][0], type->header.desc.fn_name,
                  (type->pointer) ? (type->pointer) : "NULL")
}
...
static void print_assert_u8(void *ctx, void *vas) {
  ...
  const char *print_assert_long_u8[][2] = {
      {"\"%s\". Expected %u (0x%02x) == result %u (0x%02x) -> ok",
       "\"%s\". Expected %u (0x%02x), but found %u (0x%02x) -> fail"},
      {"\"%s\". Unexpected %u (0x%02x) != result %u (0x%02x) -> ok",
       "\"%s\". Unexpected %u (%02x) == result %u (0x%02x) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_long_u8[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_long_u8[idx][0], type->header.desc.fn_name,
                  (unsigned int)type->expected, type->expected,
                  (unsigned int)type->result, type->result)
}
...
static void print_assert_s8(void *ctx, void *vas) {
  ...
  const char *print_assert_long_s8[][2] = {
      {"\"%s\". Expected %d (0x%02x) == result %d (0x%02x) -> ok",
       "\"%s\". Expected %d (0x%02x), but found %d (0x%02x) -> fail"},
      {"\"%s\". Unexpected %d (0x%02x) != result %d (0x%02x) -> ok",
       "\"%s\". Unexpected %d (%02x) == result %d (0x%02x) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_long_s8[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_long_s8[idx][0], type->header.desc.fn_name,
                  (signed int)type->expected, type->expected & 0xFF,
                  (signed int)type->result, type->result & 0xFF)
}
...
static void print_assert_u16(void *ctx, void *vas) {
  ...
  const char *print_assert_long_u16[][2] = {
      {"\"%s\". Expected %u (0x%04x) == result %u (0x%04x) -> ok",
       "\"%s\". Expected %u (0x%04x), but found %u (0x%04x) -> fail"},
      {"\"%s\". Unexpected %u (0x%04x) != result %u (0x%04x) -> ok",
       "\"%s\". Unexpected %u (%04x) == result %u (0x%04x) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_long_u16[idx][1], type->header.desc.fn_name,
                  (unsigned int)type->expected, type->expected,
                  (unsigned int)type->result, type->result)
  ...
  SUCCESS_MSG_FMT(print_assert_long_u16[idx][0], type->header.desc.fn_name,
                  (unsigned int)type->expected, type->expected,
                  (unsigned int)type->result, type->result)
}
...
static void print_assert_s16(void *ctx, void *vas) {
  ...
  const char *print_assert_s16[][2] = {
      {"\"%s\". Expected %d (0x%04x) == result %d (0x%04x) -> ok",
       "\"%s\". Expected %d (0x%04x), but found %d (0x%04x) -> fail"},
      {"\"%s\". Unexpected %d (0x%04x) != result %d (0x%04x) -> ok",
       "\"%s\". Unexpected %u (%04x) == result %d (0x%04x) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_s16[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_s16[idx][0], type->header.desc.fn_name,
                  (signed int)type->expected, type->expected & 0xFFFF,
                  (signed int)type->result, type->result & 0xFFFF)
}
...
static void print_assert_u32(void *ctx, void *vas) {
  ...
  const char *print_assert_u32[][2] = {
      {"\"%s\". Expected %u (0x%08x) == result %u (0x%08x) -> ok",
       "\"%s\". Expected %u (0x%08x), but found %u (0x%08x) -> fail"},
      {"\"%s\". Unexpected %u (0x%08x) != result %u (0x%08x) -> ok",
       "\"%s\". Unexpected %u (%08x) == result %u (0x%08x) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_u32[idx][1], type->header.desc.fn_name,
                  (unsigned int)type->expected, type->expected,
                  (unsigned int)type->result, type->result)
  ...
  SUCCESS_MSG_FMT(print_assert_u32[idx][0], type->header.desc.fn_name,
                  (unsigned int)type->expected, type->expected,
                  (unsigned int)type->result, type->result)
}
...
static void print_assert_s32(void *ctx, void *vas) {
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_s32[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_s32[idx][0], type->header.desc.fn_name,
                  (signed int)type->expected, type->expected,
                  (signed int)type->result, type->result)
}

_Static_assert(sizeof(unsigned long long int) == sizeof(uint64_t),
               "Assert error. Unsingned long int must be equal 64 bit");
static void print_assert_u64(void *ctx, void *vas) {
  ...
  const char *print_assert_u64[][2] = {
      {"\"%s\". Expected %lu (0x%016llx) == result %lu (0x%016llx) -> ok",
       "\"%s\". Expected %lu (0x%016llx), but found %lu (0x%016llx) -> fail"},
      {"\"%s\". Unexpected %lu (0x%016llx) != result %lu (0x%016llx) -> ok",
       "\"%s\". Unexpected %lu (%016llx) == result %lu (0x%016llx) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_u64[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_u64[idx][0], type->header.desc.fn_name,
                  (unsigned long long int)type->expected, type->expected,
                  (unsigned long long int)type->result, type->result)
}

_Static_assert(sizeof(long long int) == sizeof(int64_t),
               "Assert error. Long int must be equal 64 bit");
static void print_assert_s64(void *ctx, void *vas) {
  ...
  const char *print_assert_s64[][2] = {
      {"\"%s\". Expected %ld (0x%016llx) == result %ld (0x%016llx) -> ok",
       "\"%s\". Expected %ld (0x%016llx), but found %ld (0x%016llx) -> fail"},
      {"\"%s\". Unexpected %ld (0x%016llx) != result %ld (0x%016llx) -> ok",
       "\"%s\". Unexpected %ld (%016llx) == result %ld (0x%016llx) -> fail"}};
  ...
  if (error) {
    ...
    ERROR_MSG_FMT(print_assert_s64[idx][1], type->header.desc.fn_name,
  ...
  SUCCESS_MSG_FMT(print_assert_s64[idx][0], type->header.desc.fn_name,
                  (long long int)type->expected, type->expected,
                  (long long int)type->result, type->result)
}
...
static void print_assert_fail(void *ctx, void *vas) {
  ...
  ERROR_MSG_FMT("\"%s\". Fail", type->header.desc.fn_name)
...
static void add_test(void *ctx, void *vas) {
  ...
  if (_c_test_ptr) {
    sz_tmp = (((C_TEST_HEADER *)_c_test_ptr)->tests) * sizeof(C_TEST_FN) +
             sizeof(C_TEST_HEADER);
    ...
    if (!(p = realloc(_c_test_ptr, sz_tmp + sizeof(C_TEST_FN)))) {
      ...
      if ((err = free_vargs(vas)))
        ERROR_MSG_FMT(
            "free_vargs @ add_test on memory reallocation error = %d at "
            "pointer (%p)",
            err, vas)
      exit(1);
    }
  ...
  if (!(p = malloc((sz_tmp = sizeof(C_TEST_HEADER)) + sizeof(C_TEST_FN)))) {
    ...
    if ((err = free_vargs(vas)))
      ERROR_MSG_FMT(
          "free_vargs @ add_test on memory allocation for creating header "
          "error = %d at pointer (%p)",
          err, vas)
    exit(1);
  }
...
add_test_EXIT1:
  memcpy((_c_test_ptr = p) + sz_tmp, ctx,
         ((C_TEST_TYPE_HEADER *)ctx)->desc.blk_size);
  TITLE_MSG_FMT("Adding test instance \"%s\" (%d)",
                ((C_TEST_FN_DESCRIPTION *)ctx)->fn_name,
...
static void assert_equal_bool(int expected, int result, void *vas) {
  static C_TEST_TYPE_BOOL type;

  (expected == C_TEST_TRUE)
...
#define CHECK_BOOL(fn_name)                                                   \
  if ((value != C_TEST_FALSE) && (value != C_TEST_TRUE)) {                    \
    ERROR_MSG_FMT(                                                            \
        "Wrong value %d in %s. Was expected C_TEST_FALSE or C_TEST_TRUE but " \
        "found %d (0x%08x)",                                                  \
        value, fn_name, value, value)                                         \
    abort_tests();                                                            \
  }
  ...
  *vas = NULL;
  ...
  if (p == VAS_END_SIGNATURE) {
    if (((sig = *((uint64_t *)p)) != VERIFY_VAS_SIG_VALID)) {
      ERROR_MSG_FMT("Wrong message in %s signature @ (%p) with value (0x%016x)",
                    FN_MACRO_NAME, p, (unsigned long long int)sig)
      return -101;
    }
    return 0;
  }
...
static void assert_int(int expected, int result, C_TEST_FN_DESCRIPTION *desc,
                       void *vas) {
...
void assert_equal_int(int expected, int result, ...) {
  ...
  va_start(va, result);
  if (assert_warning_util(&vas, (void *)va_arg(va, void *),
                          "C_ASSERT_EQUAL_INT")) {
    va_end(va);
    abort_tests();
  }
...
static void assert_longint(long long int expected, long long int result,
                           C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
void assert_equal_longint(long long int expected, long long int result, ...) {
  ...
  assert_longint(expected, result, &C_TEST_FN_DESCRIPTION_ASSERT_EQ_LONG_INT,
                 vas);
}
...
void assert_not_equal_longint(long long int expected, long long int result,
  ...
  assert_longint(expected, result,
                 &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_LONG_INT, vas);
}

static void assert_unsigned_longint(unsigned long long int expected,
...
void assert_equal_unsigned_longint(unsigned long long int expected,
                                   unsigned long long int result, ...) {
  void *vas;
  va_list va;
  ...
  assert_unsigned_longint(expected, result,
                          &C_TEST_FN_DESCRIPTION_ASSERT_EQ_UNSIGNED_LONG_INT,
                          vas);
}

void assert_not_equal_unsigned_longint(unsigned long long int expected,
                                       unsigned long long int result, ...) {
  void *vas;
  va_list va;
  ...
  assert_unsigned_longint(
      expected, result, &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_UNSIGNED_LONG_INT,
      vas);
}

static void assert_double(double expected, double result, double delta,
                          C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
void assert_equal_double(double expected, double result, double delta, ...) {
  ...
  assert_double(expected, result, delta,
                &C_TEST_FN_DESCRIPTION_ASSERT_EQ_DOUBLE, vas);
}
...
void assert_not_equal_double(double expected, double result, double delta,
  ...
  assert_double(expected, result, delta,
                &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_DOUBLE, vas);
}

static void assert_byte(void *expected, void *result, size_t size,
                        C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
void assert_equal_byte(void *expected, void *result, size_t size, ...) {
  void *vas;
  va_list va;
  ...
  assert_byte(expected, result, size, &C_TEST_FN_DESCRIPTION_ASSERT_EQ_BYTE,
              vas);
}

void assert_not_equal_byte(void *expected, void *result, size_t size, ...) {
  void *vas;
  va_list va;
  ...
  assert_byte(expected, result, size, &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_BYTE,
              vas);
}

static void assert_string(const char *expected, const char *result,
                          C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
void assert_not_equal_string(const char *expected, const char *result, ...) {
  ...
  assert_string(expected, result, &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_STRING,
                vas);
}
...
void assert_equal_string_ignore_case(const char *expected, const char *result,
  ...
  assert_string(expected, result,
                &C_TEST_FN_DESCRIPTION_ASSERT_EQ_STRING_IGNORE_CASE, vas);
}

void assert_not_equal_string_ignore_case(const char *expected,
                                         const char *result, ...) {
  void *vas;
  va_list va;
  ...
  assert_string(expected, result,
                &C_TEST_FN_DESCRIPTION_ASSERT_NOT_EQ_STRING_IGNORE_CASE, vas);
}

static void assert_nullable(void *result, C_TEST_FN_DESCRIPTION *desc,
                            void *vas) {
...
static void assert_u8(uint8_t expected, uint8_t result,
                      C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_s8(int8_t expected, int8_t result,
                      C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_u16(uint16_t expected, uint16_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_s16(int16_t expected, int16_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_u32(uint32_t expected, uint32_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_s32(int32_t expected, int32_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_u64(uint64_t expected, uint64_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
static void assert_s64(int64_t expected, int64_t result,
                       C_TEST_FN_DESCRIPTION *desc, void *vas) {
...
void assert_fail(void *result, ...) {
  ...
  memcpy(&type.header.desc, &C_TEST_FN_DESCRIPTION_ASSERT_FAIL,
         sizeof(type.header.desc));
  type.pointer = result;
  TEST_BEGIN
}
...
inline int free_vargs_for_test(void *vargs) { return free_vargs(vargs); }

static char *ctest_setter_has_util(void *ctest_setter, uint32_t sig) {
  C_TEST_VARGS_MSG *res;

  if (!ctest_setter) return NULL;

  if ((res = check_vargs_sigmsg_exists(
           ((C_TEST_VARGS_MSG_HEADER *)ctest_setter)->vargs_msgs, sig)))
    return res->msg;
