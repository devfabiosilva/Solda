...
int test() {
  ...
  err = TECHNICIAN_EXECUTE_ADD(technician_data, TECHNICIAN_ADD_NAME("name ABC"),
  ...
  err = CLIENT_EXECUTE_ADD(
      ...
      CLIENT_ADD_CPF("111.111.111.00"), CLIENT_ADD_NAME("Fernanda Silva"),
  ...
  err = REPAIR_EXECUTE_ADD(
      repair, REPAIR_ADD_CLIENT_ID(1234), REPAIR_ADD_IS_BUDGET(true),
      ...
      REPAIR_ADD_LABOR_BUDGET(18000), REPAIR_ADD_DELIVERY_DATE(time(NULL)),
  ...
  err = SERVICE_EXECUTE_ADD(
      service, SERVICE_REPAIR_REQUEST_ID(1234), SERVICE_QUANTITY(172),
      SERVICE_MONETARY_TYPE(US_DOLLAR), SERVICE_UNITY_PRICE(29030),
