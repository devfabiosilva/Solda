...
#define MIN_CLIENT_DATA_REQUEST_INITIAL MIN_REPAIR_REQUESTS_INITIAL
#define MAX_CLIENT_DATA_REQUEST_LIMIT MAX_REPAIR_REQUESTS_LIMIT

_Static_assert(MIN_CLIENT_DATA_REQUEST_INITIAL > 0, "MIN_CLIENT_DATA_REQUEST_INITIAL must be greater than 0");
_Static_assert(((MIN_CLIENT_DATA_REQUEST_INITIAL & 1) == 0) && ((MAX_CLIENT_DATA_REQUEST_LIMIT & 1) == 0), "MIN_CLIENT_DATA_REQUEST_INITIAL and MAX_SERVICE_REQUESTS_LIMIT must be multiple of 2");
_Static_assert(MAX_CLIENT_DATA_REQUEST_LIMIT > MIN_CLIENT_DATA_REQUEST_INITIAL, "Wrong CLIENT_DATA_REQUEST boundaries");
#endif
